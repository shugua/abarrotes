...
public class HistorialEmpacadoController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final static Logger logger = LoggerFactory.getLogger(HistorialEmpacadoController.class);
    ...
    public void buscar() {
        model = peladoService.getEmpacadoByIdOrdenEntradaAndFechas(ordenTrabajo == null ? null : ordenTrabajo.getIdOrdenPk(), entrada == null ? null : entrada.getIdEntradaMateriaPrimaPK(), TiempoUtil.getFechaDDMMYYYY(fechaInicio), TiempoUtil.getFechaDDMMYYYY(fechaFin));
        calculaTotales();
    }
