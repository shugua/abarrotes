...
public class EnvasadoEmpacadoController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final static Logger logger = LoggerFactory.getLogger(EnvasadoEmpacadoController.class);
    ...
    public void add() {
        if (dataP.getCantidad() != null && dataP.getTipo() != null) {
